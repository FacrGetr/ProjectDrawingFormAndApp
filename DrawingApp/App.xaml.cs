...
namespace DrawingApp
{
    ...
    sealed partial class App : Application
    {
        ...
        public App()
        {
            ...
            this.Suspending += SavingProgress;
        }
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            {
                rootFrame = new Frame();
                rootFrame.NavigationFailed += AnnounceNavigationFailed;
        ...
        void AnnounceNavigationFailed(object sender, NavigationFailedEventArgs e)
        {
        ...
        private void SavingProgress(object sender, SuspendingEventArgs e)
        {
